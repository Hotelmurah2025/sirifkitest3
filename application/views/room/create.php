<div class="container">
    ...
    <div class="card">
        <div class="card-body">
            <form action="<?php echo base_url('room/store'); ?>" method="POST" id="roomForm">
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="number" class="form-label">Nomor Kamar *</label>
                            <input type="text" class="form-control" id="number" name="number" 
                                   value="<?php echo set_value('number'); ?>" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="type" name="type" required>
                                ...
                                <option value="Standard" <?php echo set_select('type', 'Standard'); ?>>Standard</option>
                                <option value="Deluxe" <?php echo set_select('type', 'Deluxe'); ?>>Deluxe</option>
                                <option value="Suite" <?php echo set_select('type', 'Suite'); ?>>Suite</option>
                            </select>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="status" name="status" required>
                                ...
                                <option value="occupied" <?php echo set_select('status', 'occupied'); ?>>Occupied</option>
                                <option value="dirty" <?php echo set_select('status', 'dirty'); ?>>Dirty</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="facilities" name="facilities" 
                              rows="3"><?php echo set_value('facilities'); ?></textarea>
